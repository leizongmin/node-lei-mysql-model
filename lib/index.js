...
Model.prototype.list = function (query, options, callback) {
  ...
  if (typeof options.order === 'string') {
    debug('auto format list options');
    options = me.formatListOptions(options);
  }
...
Model.create = function (options) {
  var m = new Model(options);
  var base = {};
  Object.keys(Model.prototype).forEach(function (i) {
    base[i] = function () {
      return Model.prototype[i].apply(base, arguments);
    };
  });
